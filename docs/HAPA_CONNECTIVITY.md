...
Generated: 2026-06-03T23:17:21.543Z
...
- Node id: `hapa-crypto-node`
- Repo name: `hapa-crypto-node`
- Hapa system group: `nodes/trust` (Nodes / Trust)
- Target assembly path: `hapa-system/nodes/trust/hapa-crypto-node`
- Link mode: `local_workspace_pointer_until_remote_exists`

## Role

This node handles trust, keys, crypto, or authorization boundaries; local secrets must stay outside public source.
...
- Operator-provided secrets through environment variables or local ignored files.

## Writes To

- Source-safe docs, schemas, manifests, or small fixtures that can pass publication preflight.
- Verification artifacts or public key metadata, not private keys or tokens.
...
| `hapa-keys-node` | Shares the Nodes / Trust module group. |
